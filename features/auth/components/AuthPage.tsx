  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-transparent px-4 relative overflow-hidden'>
      ...
      <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none'>
        {/* Основной яркий центр */}
        <div className='w-[350px] h-[350px] bg-cyan-500/40 rounded-full blur-[80px] mix-blend-screen' />
        {/* Внешний мягкий ореол */}
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-400/30 rounded-full blur-[140px]' />
      </div>

      {/* <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none z-10' /> */}
          ...
          >
            {isLogin ? (
              ...
              <span>
                ...
                <span className='text-cyan-500 font-medium'>Log in</span>
              </span>
            )}
          </button>
        </div>
